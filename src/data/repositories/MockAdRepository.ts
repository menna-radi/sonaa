...
export class MockAdRepository implements AdRepository {
  private campaigns: Campaign[] = [
    ...
    { id: '4', name: 'Jerusalem Deep Cleaning', placement: 'Category Page', status: 'Active', impressions: 210000, ctr: 3.9, conversions: 1204, budget: 8000 },
    { id: '5', name: 'Ramallah Movers Special', placement: 'Home Banner', status: 'Active', impressions: 65000, ctr: 3.1, conversions: 340, budget: 4000 },
  ];
